...
public class Product_search_DTO {
	...
	public String toString() {
		return "Product_search_DTO [product_no=" + product_no + ", view_cnt=" + view_cnt + ", price=" + price
				+ ", seller_id=" + seller_id + ", category_name=" + category_name + ", buyer_id=" + buyer_id
				+ ", title=" + title + ", detail=" + detail + ", product_image=" + product_image + ", product_state="
				+ product_state + ", create_at=" + create_at + ", update_at=" + update_at + ", location=" + location
				+ "]";
	}
