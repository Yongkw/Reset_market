  ...
  <body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
	...
	<div class="card align-middle" style="width:20rem; border-radius:20px;">
      ...
      <form class="form-signin" action="loginok" method="post">
        ...
        <input type="password" id="pw" name="pw" class="form-control" placeholder="비밀번호" required><br>
        <div class="searchid">
        	<button id="info_search" class="btn btn-sm btn-danger btn-block" onclick="location.href='myinfo_search'">아이디/비밀번호 찾기</button>
        </div>
