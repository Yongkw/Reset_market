...
<!DOCTYPE html>
<html>
<!-- <script type="text/javascript" src="./resources/js/newhighlow.js"></script> -->
<head>
...
<meta charset="UTF-8">
<!-- css 적용 -->
<!-- <script src="${path}/resources/js/newhighlow.js"></script> -->
		...
		<div class="dcFcMp">
			...
			<!-- 메뉴 시작 -->
				<div>
					<div>
						<div class="dvLjiM">
							<a class="gmerZt test1" href="#" id="allproduct">
								상품
