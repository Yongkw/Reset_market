...
<div class="container">
  <form action="noticesave" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <label for="input" class="control-label">Notice Category</label><i class="bar"></i>
    </div>
    <div class="form-group">
      <input type="text" required="required" name="notice_title" maxlength="100"/>
      <label for="input" class="control-label" >Title</label><i class="bar"></i>
    </div>
     <div class="form-group">
      <input type="text" required="required" name="notice_writer"/>
      <label for="input" class="control-label">Writer</label><i class="bar"></i>
    </div>
    <div class="form-group">
      <textarea required="required" name="notice_content"></textarea>
      <label for="textarea" class="control-label">Notice Content</label><i class="bar"></i>
    </div>
    
    <div class="form-group">
     <label for="input" class="control-label">Image</label>
    <label id="largeFile" for="file">
    <input type="file" id="file" name="notice_img" onchange="readURL(this);" />
	</label>
    ...
    <button type="button" class="button" onclick="location.href='notice_out'"><span>목록</span></button>
  </div>
