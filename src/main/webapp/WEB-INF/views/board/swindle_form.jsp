...
<div class="main">
   ...
   <div class="con_tit">
        <h2 style="margin: 0;">사기 피해 접수하기</h2>           
   </div>
...
<div class="hmUNzn">
		<form name="myForm" action="swindlesave" method="post" enctype="multipart/form-data">
			<main class="flimjd">
			 ...
			 <div class="con_tit">
				...
				<ul class="hcyuoc">		
					...
					<li class="iZffvT">
						...
						<div class="nqDMw">
							<div class="iIJDsQ">
								<input type="text" placeholder="리셋마켓 아이디 혹은 닉네임을 작성해주세요."
